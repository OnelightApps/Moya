...
final class NetworkLoggerPluginSpec: QuickSpec {
    override func spec() {
        ...
        it("outputs the response data") {
            ...
            let result: Result<OnelightMoya.Response, MoyaError> = .success(response)
        ...
        it("outputs a validation error message") {
            ...
            let result: Result<OnelightMoya.Response, MoyaError> = .failure(.underlying(validationResponseError, response))
        ...
        it("outputs a serialization error message") {
            ...
            let result: Result<OnelightMoya.Response, MoyaError> = .failure(.underlying(emptyResponseError, nil))
